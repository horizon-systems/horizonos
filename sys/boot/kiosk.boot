...
if mon then
	print("HorizonOS is running in Kiosk mode, and the screen will be redirected to the monitor. To undo this, go to the boot option menu by pressing a key while booting, then select the option 2.")
	term.redirect(mon)
